...
#
alias alias_diff_fish_sh='~/.shell_utils/scripts/diff_fish_sh ~/.shell_utils/aliases/'

# Shell Utils fundamental
alias shell_color_select='~/.shell_utils/scripts/color_select.sh'
...
alias ascii_theme_select='~/.shell_utils/scripts/ascii_theme_select.sh'
