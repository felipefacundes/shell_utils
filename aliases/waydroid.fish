...
alias waydroid_help='helps waydroid_help'
alias waydroid_fix_solutions='helps waydroid_fix_solutions'
alias waydroid_mount_share_folder='helps waydroid_mount_share_folder'
alias waydroid_certificate_playstore='helps waydroid_certificate_playstore'
