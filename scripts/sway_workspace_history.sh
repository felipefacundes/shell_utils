...
: <<'DOCUMENTATION'
sway_workspace_history.sh - Toggle between the two most recent workspaces in Sway
...
bindsym $mod+apostrophe exec ~/.config/sway/sway_workspace_history.sh


 FILES
- Script: "~/.config/sway/sway_workspace_history.sh"
