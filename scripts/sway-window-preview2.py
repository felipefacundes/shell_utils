...
# Script to create an Alt-Tab with thumbnails in Sway (GTK4)
    ...
    def do_activate(self):
        ...
        for node in tree.leaves():
            ...
            if node_workspace and node_workspace.name == workspace_name:
                # Check if the window is not on a different workspace (like a floating window)
        ...
        # Create items
        self.items = []
        self.index = 1  # Starts at the next one (effect of "already switched once")
