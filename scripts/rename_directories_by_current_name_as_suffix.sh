...
: <<'DOCUMENTATION'
This script is a bilingual directory renaming utility that automatically appends 
the current directory name as a suffix to all subdirectories. Its key strengths include:
...
directory's name as a suffix, facilitating organized and consistent directory naming conventions.
...
for dir in */; do
    ...
    # Generate the new name with the suffix
    new_name="${dir_name}-${current_dir}"
