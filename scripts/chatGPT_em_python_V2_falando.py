#!/bin/env python
# Credits: inteligenciamilgrau
# Channel Youtube: https://www.youtube.com/watch?v=p1mD3aYb2iw 
# Source: https://github.com/inteligenciamilgrau/videos_tutoriais/tree/main/ChatGPT_em_Python
