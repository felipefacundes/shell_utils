...
if not awful.util.file_readable(shared .. "/icons/arch-icon2.png") then
    shared    = "~/.config/awesome/"
end
...
wallpaper2    = themedir .. "/arch_linux.jpg"
wallpaper3    = sharedthemes .. "/zenburn/zenburn-arch_linux.jpg"
wallpaper4    = sharedthemes .. "/default/arch_linux.jpg"
...
theme.awesome_icon = themedir .. "/arch-icon2.png"
