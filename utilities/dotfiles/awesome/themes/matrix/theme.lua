-- matrix, awesome3 theme, by zhuravlik, based on Zenburn
...
theme.bg_normal     = "#171717a9"
theme.bg_focus      = "#171717a"
theme.bg_urgent     = "#171717"
theme.bg_minimize   = "#171717a6"
...
-- {{{ Titlebars
theme.titlebar_bg_focus  = "#171717a9"
...
-- {{{ Mouse finder
theme.mouse_finder_color = "#338000"
